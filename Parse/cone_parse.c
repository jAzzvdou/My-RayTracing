...
/*   Updated: 2025/03/25 13:50:28 by jazevedo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     valid_cone(char **splited, t_point *p, t_vector *n, t_object *n_cy, void *mlx)
{
        if (!valid_line_count(splited, 13)
                ...
                || !get_pattern_cone(splited, &n_cy->material.pattern, mlx))
                return (0);
        return (1);
}
